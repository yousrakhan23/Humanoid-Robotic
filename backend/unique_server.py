...
spec = importlib.util.spec_from_file_location("rag_service", "./rag_service.py")
...
# Create FastAPI app with a unique title to identify it
app = FastAPI(
...
async def health_check():
    ...
    return {"status": "healthy", "serverless": True, "service": "physical-ai-rag-chatbot"}
